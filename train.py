...
def main(args):
    ...
    try:
        ...
        # Propagate eval_only flag into cfg so trainers can adjust behavior.
        # cfg is frozen inside setup_cfg, so we need to defrost before
        # modifying and freeze again afterward.
        from yacs.config import CfgNode as CN
        cfg.defrost()
