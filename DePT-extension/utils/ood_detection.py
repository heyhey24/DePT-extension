...
def run_ood_detection(trainer, cfg, args, stage):
    ...
    # 打印阈值信息
    threshold_msg = f"[calibrate_threshold_from_loader] 阈值校准完成: threshold={threshold:.4f}"
    print(threshold_msg)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--score", type=str, default="MCM", choices=["energy", "MCM"], help="OOD score type: energy or MCM")
    parser.add_argument(
        "opts",
        default=None,
